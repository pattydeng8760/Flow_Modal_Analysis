...
config = {
    ...
    "data_type"           : "EXTRACT",
    "var"                 : "pressure",
    "sol_dir"             : "/project/rrg-plavoie/denggua1/BBDB_5AOA/Isosurface/Extract_Cutplane_Fine/Cut_25mm_tip_VGT/",
    "sol_file"            : "B_10AOA",
    "AoA"                 : 5,   
    ...
    "dt"                  : 1.835e-8*2000,
    "df"                  : 200,
    "freq"                : [500, 750, 1000, 1250, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000],
    "nperiod"             : 2,
    "triple_decomp"       : False,
    "vortex"              : "PV",
}
