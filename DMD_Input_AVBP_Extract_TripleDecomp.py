...
sol_dir = '/home/p/plavoie/denggua1/scratch/Bombardier_LES/B_10AOA_LES/Isosurface/Cut_PIV1_VGT/'
#sol_dir = '/project/p/plavoie/denggua1/BBDB_10AOA/Isosurface/Cut_PIV1_VGT/'
...
DMD_output_dir = 'DMD_Output_TripleDecomp_' + vortex + '_' + var + '_'+ dest_file               # Can personally Change
# 9) The destination DMD reconstructed field directory
DMD_reconstruct_dir = 'DMD_Reconstruction_Cut_'+dest_file+'_Modes_TripleDecomp'      # Can personally Change
...
max_file = 784         # Maximum number of files
reload=False
triple_decomp = True   # Perform the triple decomposition of the flow field
