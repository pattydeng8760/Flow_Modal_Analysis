...
var = 'Pressure_Hessian'
# 1) The source transient solution directory
#sol_dir = '/home/p/plavoie/denggua1/scratch/Bombardier_LES/B_10AOA_LES/Isosurface/Cut_095_TE/'
sol_dir = '/home/p/plavoie/denggua1/scratch/Bombardier_LES/B_10AOA_LES/PostProc/Pressure_Hessian/Cut_PIV1/'
# 2) The source transient solution name preamble string
#sol_file = 'B_10AOA'
sol_file = 'Pressure_Hessian'
...
#dest_file = 'Cut_095_TE'               # Can personally Change
dest_file = 'Cut_PIV1'
# 4) The mesh directory
mesh_Dir = sol_dir
# 5) The source mesh file name in .h5 format
#mesh_fileName = 'x_095chord_mesh-2400.h5' 
mesh_fileName = '/home/p/plavoie/denggua1/scratch/Bombardier_LES/B_10AOA_LES/MESH_ZONE_NEW/Bombardier_10AOA_Combine.mesh.h5'
...
max_file = 500         # Maximum number of files
